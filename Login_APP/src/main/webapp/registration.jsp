	...
	<form method="post" action="RegisterController"
		...
		<center>
				...
				<tbody>
					<tr>
						...
						<td><input type="text" id="firstName" 
							...
							required /> <span class="error-msg" id="firstNameError"></span></td>
					</tr>
					<tr>
						<td>Last Name</td>
					...
					<tr>
						...
						<td><input type="number"
							...
							class="error-msg" id="mobileNumberError"></span></td>
					</tr>
					<tr>
						<td>Email Id</td>
            ...
            maxlength="16" minlength="3"
							...
							class="error-msg" id="passwordError"></span></td>
					</tr>
					<tr>
